    ...
    <>

      {
        isValidImage ? <div dir={isRight ? "rtl" : "ltr"}
          className="opacity-80 h-[100%] bg-gray-300">
          <Header />

          <div className="profile mx-5 mt-5">
            <h1 className="text-2xl font-bold text-black/45  ">Profile</h1>
            <form onSubmit={
              ...
              <div className="employeeInfo w-[100%] h-fit bg-white rounded-lg mt-4 shadow-lg  px-4 py-4 ">
                ...
                <label className="mt-2 flex flex-col sm:flex-row sm:space-x-52" >
                  ...
                  <select
                    ...
                    onClick={
                      depatmentItems.length == 0 ? getDepartment : undefined}
