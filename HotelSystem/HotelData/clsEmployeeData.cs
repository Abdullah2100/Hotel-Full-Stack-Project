...
namespace HotelData
{
    public class clsEmployeeData
    {
        ...
        public static string connectionUrl = ServerConnection.url;

        public static clsEmployeeDto? findEmployee(
          int id
            ...
            )
        {
            ...
            try
            {
                ...
                {
                    con.Open();
                    string qery = @" getEmployeeID @employeeID = @id";
                    ...
                    using (SqlCommand cmd = new SqlCommand(qery, con))
                    {
                        ...
                        using (SqlDataReader reader = cmd.ExecuteReader())
                        {
                            if (reader.Read())
                            {
                      Console.WriteLine($"this the error from data {reader}");
                                ...
                                return new clsEmployeeDto()
                                {
                                    ...
                                    token = reader["token"] != DBNull.Value ? (string)reader["token "] : "",
                                    isBlock = reader["isBlock"] != DBNull.Value ? (bool)reader["isBlock "] : false,
            ...
            {
                Console.WriteLine($"this the error from data {ex.Message}");
                //throw ex;
            }
            return null;
